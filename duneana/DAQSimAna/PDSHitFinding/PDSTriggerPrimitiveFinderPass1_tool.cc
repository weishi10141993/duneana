////////////////////////////////////////////////////////////////////////
// Class:       PDSTriggerPrimitiveFinderPass1
// Plugin Type: service (art v2_10_03)
// File:        PDSTriggerPrimitiveFinderPass1_service.cc
//
// Generated at Tue Jun  5 07:51:38 2018 by Philip Rodrigues using cetskelgen
// from cetlib version v3_02_00.
////////////////////////////////////////////////////////////////////////

#include "duneana/DAQSimAna/PDSHitFinding/PDSTriggerPrimitiveFinderPass1.h"
...
PDSTriggerPrimitiveFinderPass1::PDSTriggerPrimitiveFinderPass1(fhicl::ParameterSet const & p)
...
std::vector<short> PDSTriggerPrimitiveFinderPass1::downSample(const std::vector<short>& orig)
{
    //---------------------------------------------
    // Do the downsampling
    //---------------------------------------------
...
std::vector<short> PDSTriggerPrimitiveFinderPass1::findPedestal(const std::vector<short>& waveform)
{
    //---------------------------------------------
...
std::vector<short> PDSTriggerPrimitiveFinderPass1::filter(const std::vector<short>& pedsub)
{
    //---------------------------------------------
    // Filtering
    //---------------------------------------------
...
void
PDSTriggerPrimitiveFinderPass1::hitFinding(const std::vector<short>& waveform,
                                        std::vector<PDSTriggerPrimitiveFinderTool::Hit>& hits,
                                        int channel)
{
    //---------------------------------------------
    // Hit finding
    ...
    PDSTriggerPrimitiveFinderTool::Hit hit(channel, 0, 0, 0, 0);
...
std::vector<PDSTriggerPrimitiveFinderTool::Hit>
PDSTriggerPrimitiveFinderPass1::findHits(const std::vector<unsigned int>& channel_numbers, 
                                      const std::vector<std::vector<short>>& collection_samples)
{
    auto hits=std::vector<PDSTriggerPrimitiveFinderTool::Hit>();
...
DEFINE_ART_CLASS_TOOL(PDSTriggerPrimitiveFinderPass1)
