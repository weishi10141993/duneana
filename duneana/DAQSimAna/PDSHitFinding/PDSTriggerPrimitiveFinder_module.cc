...
class PDSTriggerPrimitiveFinder : public art::EDProducer {
public:
  explicit PDSTriggerPrimitiveFinder(fhicl::ParameterSet const & p);
  // The compiler-generated destructor is fine for non-base
  // classes without bare pointers or other resource use.

  // Plugins should not be copied or assigned.
  PDSTriggerPrimitiveFinder(PDSTriggerPrimitiveFinder const &) = delete;
  PDSTriggerPrimitiveFinder(PDSTriggerPrimitiveFinder &&) = delete;
  PDSTriggerPrimitiveFinder & operator = (PDSTriggerPrimitiveFinder const &) = delete;
  PDSTriggerPrimitiveFinder & operator = (PDSTriggerPrimitiveFinder &&) = delete;
...
PDSTriggerPrimitiveFinder::PDSTriggerPrimitiveFinder(fhicl::ParameterSet const & p)
    : EDProducer{p}, m_inputTag(p.get<std::string>("InputTag", "daq")),
      m_finder{art::make_tool<PDSTriggerPrimitiveFinderTool>(p.get<fhicl::ParameterSet>("finder"))}
{
...
DEFINE_ART_MODULE(PDSTriggerPrimitiveFinder)
