...
class PDSTriggerPrimitiveFinderPass1 : public PDSTriggerPrimitiveFinderTool {
public:
  explicit PDSTriggerPrimitiveFinderPass1(fhicl::ParameterSet const & p);
...
protected:
    ...
    void hitFinding(const std::vector<short>& waveform, std::vector<PDSTriggerPrimitiveFinderTool::Hit>& hits, int channel);
